...
dDAGFunctionStatementAssigment::dDAGFunctionStatementAssigment(dList<dDirectAcyclicgraphNode*>& allNodes, dDAGExpressionNodeVariable* const leftVariable, dDAGExpressionNode* const expression)

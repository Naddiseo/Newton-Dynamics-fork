...
bool dCollisionChamferCylinderNodeInfo::Deserialize (TiXmlElement* const rootNode, int revisionNumber) 
{
...
void dCollisionChamferCylinderNodeInfo::SerializeBinary (FILE* const file) 
{
_ASSERTE (0);

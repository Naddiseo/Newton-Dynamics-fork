...
#define DG_INITIAL_CONTATCT_SIZE		(1024 * 32)
...
dgWorld::dgWorld(dgMemoryAllocator* const allocator)
	...
	,m_pairMemoryBuffer (DG_INITIAL_CONTATCT_SIZE, allocator, 64)
...
//dgThreadHive::SetThreadsCount(16);
//dgThreadHive::SetThreadsCount(32);

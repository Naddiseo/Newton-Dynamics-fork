...
void dgMeshEffect::GetMaterialGetIndexStream (dgIndexArray* const handle, dgInt32 materialHandle, dgInt32* indexArray)
{
	dgInt32 index;
	dgInt32 textureID;
...
void dgMeshEffect::GetMaterialGetIndexStreamShort (dgIndexArray* const handle, dgInt32 materialHandle, dgInt16* indexArray)
{
	dgInt32 index;
	dgInt32 textureID;
...
void dgMeshEffect::PlaneClipMesh (const dgMatrix& planeMatrix, const dgMatrix& planeTextMatrix, dgInt32 planeMaterial, dgMeshEffect** const left, dgMeshEffect** const right) const 
{
	...
	*right = NULL;
	...
	dgMeshEffect* backMesh = new (GetAllocator()) dgMeshEffect (GetAllocator(), true);
	dgMeshEffect* frontMesh = new (GetAllocator()) dgMeshEffect (GetAllocator(), true);
	...
	if (backMesh && frontMesh) {
		...
		dgMeshEffect planeMesh (GetAllocator(), planeMatrix, dgFloat32(size), dgFloat32(size), planeMaterial, planeTextMatrix, planeTextMatrix);
...
void dgMeshEffect::ClipMesh (const dgMeshEffectSolidTree* const clipper, dgMeshEffect** const left, dgMeshEffect** const right, dgMeshEffect** const coplanar) const
{
	...
	dgMeshEffect* const backMesh = new (GetAllocator()) dgMeshEffect (GetAllocator(), true);
	dgMeshEffect* const frontMesh = new (GetAllocator()) dgMeshEffect (GetAllocator(), true);

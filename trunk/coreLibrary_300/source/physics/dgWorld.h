...
//	dgUnsigned32 GetPerfomanceTicks (dgInt32 thread, dgUnsigned32 entry) const;
	...
	private:
	void CalculateContacts (dgCollidingPairCollector::dgPair* const pair, dgContactPoint* const contactBuffer, dgFloat32 timestep, dgInt32 threadIndex);
	void CalculateContactsSimd (dgCollidingPairCollector::dgPair* const pair, dgContactPoint* const contactBuffer, dgFloat32 timestep, dgInt32 threadIndex);
	...
	dgInt32 CalculateHullToHullContacts (dgCollisionParamProxy& proxi) const;
	dgInt32 CalculateHullToHullContactsSimd (dgCollisionParamProxy& proxi) const;
	dgInt32 CalculateBoxToSphereContacts (dgCollisionParamProxy& proxi) const;
	dgInt32 CalculateSphereToSphereContacts (dgCollisionParamProxy& proxi) const;
	dgInt32 CalculateCapsuleToSphereContacts (dgCollisionParamProxy& proxi) const;
	dgInt32 CalculateCapsuleToCapsuleContacts (dgCollisionParamProxy& proxi) const;
	dgInt32 SphereSphereCollision (const dgVector& sph0, dgFloat32 radius0, const dgVector& sph1, dgFloat32 radius1, dgCollisionParamProxy& proxi) const;  
	...
	dgInt32 CalculatePolySoupToHullContactsDescrete (dgCollisionParamProxy& proxi) const;
	dgInt32 CalculatePolySoupToHullContactsDescreteSimd (dgCollisionParamProxy& proxi) const;

	dgInt32 CalculatePolySoupToSphereContactsDescrete (dgCollisionParamProxy& proxi) const;
	dgInt32 CalculatePolySoupToElipseContactsDescrete (dgCollisionParamProxy& proxi) const;
	dgInt32 CalculatePolySoupToSphereContactsContinue (dgCollisionParamProxy& proxi) const;
	dgInt32 CalculateConvexToNonConvexContactsContinue (dgCollisionParamProxy& proxi) const;
	dgInt32 CalculateConvexToNonConvexContactsContinueSimd (dgCollisionParamProxy& proxi) const;
...
//	dgInt32 CalculateConvexToConvexContinuesContacts (dgCollisionParamProxy& proxi) const; 
//	dgInt32 CalculateConvexToConvexContinuesContacts (dgCollisionParamProxy& proxi) const; 
...
//	dgInt32 CalculateConvexToConvexContactsSimd (dgFloat32& timestep, dgBody* conv1, dgBody* conv2, dgFloat32 penetrationPadding, dgContactPoint* const contact) const;
	dgInt32 CalculateConvexToConvexContacts (dgCollisionParamProxy& proxi) const;
	dgInt32 CalculateConvexToConvexContactsSimd (dgCollisionParamProxy& proxi) const;
...
//	dgInt32 CalculateConvexToNonConvexContacts (dgFloat32& timestep, dgBody* conv, dgBody* nConv, dgContactPoint* const contact, dgInt32 maxContacts) const;
	dgInt32 CalculateConvexToNonConvexContacts (dgCollisionParamProxy& proxi) const;
	dgInt32 CalculateConvexToNonConvexContactsSimd (dgCollisionParamProxy& proxi) const;
	...
	void ConvexContacts (dgCollidingPairCollector::dgPair* const pair, dgCollisionParamProxy& proxi) const;
	void ConvexContactsSimd (dgCollidingPairCollector::dgPair* const pair, dgCollisionParamProxy& proxi) const;
	void CompoundContacts (dgCollidingPairCollector::dgPair* const pair, dgCollisionParamProxy& proxi) const;
	void CompoundContactsSimd (dgCollidingPairCollector::dgPair* const pair, dgCollisionParamProxy& proxi) const;

	void SceneContacts (dgCollidingPairCollector::dgPair* const pair, dgCollisionParamProxy& proxi) const;
	void SceneContacts (const dgCollisionScene::dgProxy& sceneProxy, dgCollidingPairCollector::dgPair* const pair, dgCollisionParamProxy& proxi) const;
	
	void SceneContactsSimd (dgCollidingPairCollector::dgPair* const pair, dgCollisionParamProxy& proxi) const;
	void SceneContactsSimd (const dgCollisionScene::dgProxy& sceneProxy, dgCollidingPairCollector::dgPair* const pair, dgCollisionParamProxy& proxi) const;

	dgInt32 ClosestPoint (dgCollisionParamProxy& proxi) const;
	...
	//dgInt32 m_jacobiansMemorySizeInBytes[DG_MAX_THREADS_HIVE_COUNT];
	//dgInt32 m_internalForcesMemorySizeInBytes[DG_MAX_THREADS_HIVE_COUNT];
	//void* m_jacobiansMemory[DG_MAX_THREADS_HIVE_COUNT]; 
	//void* m_internalForcesMemory[DG_MAX_THREADS_HIVE_COUNT];  

...
dgFloat32 dgCollisionCapsule::RayCast(const dgVector& q0, const dgVector& q1,
...
//		dgVector dp (p1 - q0);
    ...
    if (desc > dgFloat32(1.0e-8f))
    {
      ...
      if ((t1 >= dgFloat32(0.0f)) && t1 < dgFloat32(1.0f))
      {
        ...
        if (x > m_height[0])
        {
          dgVector h(m_height[0], dgFloat32(0.0f), dgFloat32(0.0f),
              dgFloat32(0.0f));
          dgVector dq(q1 - q0);
          dgVector dqp0(q0 - h);
          a = dq % dq;
    ...
    const dgVector& origin, dgVector* const contactsOut) const
{
  ...
  {
    dgFloat32 x =
        (normal.m_x > dgFloat32(0.0f)) ? dgFloat32(1.0f) : dgFloat32(-1.0f);
    contactsOut[count] = dgVector(x, dgFloat32(0.0f), dgFloat32(0.0f),
        dgFloat32(0.0f));
    count = 1;
  ...
  else
  {
    ...
    dgVector maxDir(
        (normal1.m_x > dgFloat32(0.0f)) ?
            m_silhuette[3].m_x : -m_silhuette[3].m_x,
        (normal1.m_y > dgFloat32(0.0f)) ?
            m_silhuette[3].m_y : -m_silhuette[3].m_y, dgFloat32(0.0f),
        dgFloat32(0.0f));

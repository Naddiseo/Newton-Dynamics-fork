...
public:
  ...
  DG_INLINE dgInt32 RayTestSimd(const FastRayTest& ray,
  ...
  DG_INLINE dgInt32 RayTest(const FastRayTest& ray,
      const dgTriplex* const vertexArray) const
  {
    dgFloat32 tmin = 0.0f;
    dgFloat32 tmax = 1.0f;
...
//		const dgAABBTree* const root = this;
  ...
  void ForAllSectorsRayHitSimd(const FastRayTest& raySrc,
  ...
  void ForAllSectorsRayHit(const FastRayTest& raySrc, const dgInt32* indexArray,
...
void dgAABBPolygonSoup::ForAllSectorsRayHit(const FastRayTest& ray,
    dgRayIntersectCallback callback, void* const context) const
{
  dgAABBTree* tree;
...
void dgAABBPolygonSoup::ForAllSectorsRayHitSimd(const FastRayTest& ray,
    dgRayIntersectCallback callback, void* const context) const
{
  dgAABBTree* tree;

...
class dgMeshEffect: public dgPolyhedra, public dgRefCounter
{
	...
	dgInt32 CreateVoronoiPartition (dgMeshEffect** const arrayOut, dgInt32 maxCount, dgInt32 pointsCount, dgInt32 pointStrideInBytes, const dgFloat32* const pointCloud, dgInt32 interionMaterial) const;
